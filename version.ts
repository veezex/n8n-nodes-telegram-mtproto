...
if (await isDirty())
	throw new Error('There are uncommitted changes. Commit them before releasing.');
...
await Bun.write(path, JSON.stringify(Object.assign(json, { version: desired }), null, 2));
